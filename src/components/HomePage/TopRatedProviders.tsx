...
import { Star, MapPin, Check, Clock, ArrowRight } from "lucide-react";
...
const badgeStyles: Record<"Top Rated" | "Expert" | "Premium", string> = {
  "Top Rated": "bg-gradient-to-r from-yellow-400 to-orange-500 text-white",
  "Expert": "bg-gradient-to-r from-purple-500 to-indigo-600 text-white",
  "Premium": "bg-gradient-to-r from-pink-500 to-rose-600 text-white",
};
                  ...
                  <div className="absolute top-0 left-0 right-0 flex items-center justify-between p-4">
                    ...
                    {provider.verified && (
                      <motion.div
                        ...
                        className="flex items-center justify-center w-6 h-6 bg-green-500 rounded-full shadow-lg ring-2 ring-white dark:ring-gray-800"
                      >
